...
dizhen<-read.csv("D:/dizhen/jingqu/dizhen.new.all.csv",header=T)
dizhen<-dizhen[,-c(1,2)]
...
china.plot+geom_point(data=dizhen5,aes(x=jingdu,y=weidu,size=zhenji),fill="gray60",alpha=0.6,shape=21,color="gray60")
